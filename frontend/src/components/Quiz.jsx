...
const SurveyForm = () => {
  ...
  const handleChange = (event) => {
    ...
    // For checkboxes, handle differently
    if (type === "checkbox") {
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="question-box">
            <label htmlFor="question8">
              8. On a scale of 1 to 5, how often do you find yourself using
              Social media without a specific purpose?
              <br />
              <input
                type="radio"
                id="question8-1"
          ...
          <div className="question-box">
            <label htmlFor="question12">
              12. On a scale of 1 to 5, do you find it difficult to concentrate
              on things?
              <br />
              <input
                type="radio"
          ...
          <div className="question-box">
            <label htmlFor="question14">
              14. Following the previous question, on a scale of 1 to 5, how do
              you feel about these comparisons, generally speaking?
              <br />
              <input
                type="radio"
                id="question14-1"
          ...
          <div className="question-box">
            <label htmlFor="question16">
              16. On a scale of 1 to 5, how frequently does your interest in
              daily activities fluctuate?
              <br />
              <input
                type="radio"
                id="question16-1"
